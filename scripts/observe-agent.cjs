...
function main(){
  try{
    ...
    const child=spawnSync(path.join(root,'packages/memory/.venv/bin/python'),args,{input:JSON.stringify(p.payload),env,encoding:'utf8',timeout:4500,maxBuffer:65536});
