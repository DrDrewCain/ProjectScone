...
_GUIDANCE = (
    ...
    "subject are the same name ignoring case and spacing (a value whose case carries "
    "meaning must match exactly; prose and pronouns never join); it is not a stored "
    "semantic relation. Paths are evidence connections, not transitive conclusions. "
