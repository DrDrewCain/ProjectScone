...
def create_app(
    ...
    async def capabilities(_space: str = Depends(space_for)) -> dict:
        ...
        features = {
            ...
            "entities.read": True, "graph.knowledge": True, "graph.report": True, "graph.path": True, "graph.export": True, "graph.context": True, "graph.timeline": True, "graph.sources": True, "recall.graph_boost": True, "graph.knowledge_paging": True,
