...
class RecallScopeKwargs(TypedDict):
    where: dict[str, str]
    kind: str | None
...
class RecallScope:
    ...
    @classmethod
    def validated(cls, *, where: Mapping[str, str] | None = None, kind: str | None = None,
                  source_prefix: str | None = None, since: str | None = None, until: str | None = None) -> "RecallScope":
    ...
    def kwargs(self) -> RecallScopeKwargs:
    ...
    @classmethod
    def from_mapping(cls, value: object) -> "RecallScope":
        if value is None:
            value = {}
        ...
        try:
            return cls.validated(**cast(RecallScopeKwargs, value))
