...
from test_evidence_answer import claim, material, packet, passage, path
...
@pytest.mark.parametrize('case', json.loads((Path(__file__).parent / 'fixtures/tool_action_cases.json').read_text())['cases'],
